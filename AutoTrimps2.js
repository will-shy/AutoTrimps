var ATversion='Zek v4.5.0',atscript=document.getElementById('AutoTrimps-script'),basepath='https://Luterium.github.io/AutoTrimps/',modulepath='modules/';null!==atscript&&(basepath=atscript.src.replace(/AutoTrimps2\.js$/,''));
...
function initializeAutoTrimps() {
    ...
    debug('AutoTrimps - Luterium Fork Loaded!', '*spinner3');
}

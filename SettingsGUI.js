...
function initializeAllSettings() {
    ...
    createSetting('Rautomapsportal', 'AM Always', 'Makes sure Auto Maps is on <b>ALWAYS</b>. Sometimes AT will turn off Automaps during timewarp. ', 'boolean', false, null, 'Maps');

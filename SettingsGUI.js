...
function initializeAllSettings() {
    ...
    createSetting('Rtimefarmmaz', 'Time Farm Settings', 'Click to open the Time Farm settings. ', 'boolean', 1, null, 'Μaps');
    ...
    createSetting('Rtimemapselection', 'TF: Map Selection', 'Select which map you prefer to use.', 'dropdown', 'textValue', 'undefined', null, 'Μaps');
    ...
    createSetting('Rtimegatherselection', 'TF: Gather Selection', 'Select which resource to Gather. ', 'dropdown', 'textValue', 'undefined', null, 'Μaps');
...
function updateCustomButtons() {
    ...
    turnOff("Rtimemaplevel");
    turnOff("Rtimemapselection");
    turnOff("Rtimespecialselection");
    turnOff("Rtimegatherselection");
